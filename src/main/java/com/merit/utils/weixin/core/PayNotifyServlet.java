...
import com.merit.utils.weixin.model.PayBuyPost;
import com.merit.utils.weixin.util.Tools;
...
public class PayNotifyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			xs.alias("xml", PayBuyPost.class);
			String xmlMsg = Tools.inputStream2String(in);
			System.out.println("====回调返回："+xmlMsg);
			postData = (PayBuyPost) xs.fromXML(xmlMsg);
